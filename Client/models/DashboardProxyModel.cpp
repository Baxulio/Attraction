...
void DashboardProxyModel::invalidate()
{
    invalidateFilter();
}

bool DashboardProxyModel::dateInRange(const QDateTime &dateTime, bool mode) const
{
    if(mode){
...
QVariant DashboardProxyModel::headerData(int section, Qt::Orientation orientation, int role) const
{
